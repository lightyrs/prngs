module VideosHelper
  ...
  def youtube_player(video)
    if video.provider.downcase == "youtube"
      ...
      "<iframe src='http://player.vimeo.com/video/#{video.video_id}?title=0&amp;byline=0&amp;portrait=0&amp;color=0fb0d4&amp;wmode=transparent' width='560' height='315' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>"
    else
      video.title
    end
  end
